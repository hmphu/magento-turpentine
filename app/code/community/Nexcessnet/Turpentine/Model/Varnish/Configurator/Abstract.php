...
EOS;
    ...
    /**
     * Get the device normalization sub routine
     *
     * @return string
     */
    protected function _vcl_sub_normalize_device() {
        /**
         * Mobile regex from
         * @link http://magebase.com/magento-tutorials/magento-design-exceptions-explained/
         */
...
EOS;
    ...
    protected function _getTemplateVars() {
        ...
        if (Mage::getStoreConfig('turpentine_vcl/normalization/device')) {
            $vars['normalize_device'] = $this->_vcl_sub_normalize_device();
        }
